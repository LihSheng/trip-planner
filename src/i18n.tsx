...
const translations = {
  en: {
    ...
    itinerary: 'Itinerary', itineraryHint: 'Drag places between days to shape your route.', addDay: 'Add day', day: 'Day {number}', expandDay: 'Expand day', collapseDay: 'Collapse day', removeDay: 'Remove day', stopsVisited: '{stops} stops · {visited} visited', dayTitle: 'Day {number} title', dropPlace: 'Drop a place here', emptyDayHint: 'Drag a place here or tap + to add.', moveToDay: 'Move to day…',
...
export function categoryLabel(t: I18nValue['t'], category: string) {
  const key = ({ Landmark: 'landmark', Nature: 'nature', Culture: 'culture', Food: 'food', Shopping: 'shopping', Relaxation: 'relaxation', Accommodation: 'accommodation', Airport: 'airport', Station: 'station', Transit: 'transit' } as Record<string, TranslationKey>)[category];
