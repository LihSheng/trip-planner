...
const translations = {
  en: {
    ...
    searchForPlace: 'Search for a place', searchExample: 'e.g. Raohe Night Market', searchDisabled: 'Add a Geoapify API key to enable search', searchDescription: 'Search Taiwan places and fill the coordinates automatically.', placeName: 'Place name', regionCity: 'Region or city', category: 'Category', latitude: 'Latitude', longitude: 'Longitude', notes: 'Notes', notesPlaceholder: 'Food to try, ideal visiting time, transport notes…', addToUnscheduled: 'Add to unscheduled', saveChanges: 'Save changes', enterPlaceName: 'Enter a place name', enterRegion: 'Enter a region or city', validLatitude: 'Use a valid latitude', validLongitude: 'Use a valid longitude',
